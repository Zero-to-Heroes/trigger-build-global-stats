...
export class Replay {
	...
	public static buildContexts(replay: Replay): readonly StatContext[] {
		return ['global', Replay.buildContext(replay)];
	}

	private static buildContext(replay: Replay): StatContext {
